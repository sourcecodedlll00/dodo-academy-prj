                ...
                <ul class="list-unstyled navbar__list">
                    <li class="active has-sub">
                        <a class="js-arrow" href="enrolled-courses.php">
                            <i class=""></i>Explore Courses</a>
                    </li>
                    <li>
                        <a href="student-login.php">
                            <i class=""></i>Student Login
                        </a>
                    </li>
                    <li>
                        <a href="teacher-login.php">
                            <i class=""></i>Teacher Login
                        </a>
                    </li>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="single-post-main.php?course_id=<?php echo $son['course_id']?>">Detayları Gör</a>
                                    </div>
                                </div>
                            </div>
                            <?php

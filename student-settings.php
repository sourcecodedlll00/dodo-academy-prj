...
if(!isset($_SESSION['oturum'])){
    ...
    $details = $db -> query("SELECT enrolled_courses.enrollment_id, enrolled_courses.enrollment_date, student_informations.student_name, student_informations.student_email, student_informations.student_id FROM enrolled_courses, student_informations WHERE student_informations.student_id = enrolled_courses.student_id && enrolled_courses.course_id = '$teacher_id'");
                ...
                <div class="container-fluid">
                    <div class="row m-t-25">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Student Settings</h3>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <?php
                                        while($son = $details->fetch_assoc()){
                                            ?>
                                            <tbody>
                                            <tr class="tr-shadow">
                                                <td><?php echo $son['enrollment_id']?></td>
                                                <td>
                                                    <span class="block-email"><?php echo $son['enrollment_date']?></span>
                                                </td>
                                                <td class="desc"><?php echo $son['student_name']?></td>
                                                <td> <?php echo $son['student_email']?></td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button>
                                                        <a href="delete-student.php?enrollment_id=<?php echo $son['enrollment_id']?>">Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="spacer"></tr>

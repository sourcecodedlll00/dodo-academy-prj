...
if(!isset($_SESSION['oturum'])){
    ...
    $lectureInformations= $db -> query("SELECT lecture_id, lecture_name, lecture_description, lecture_video FROM lecture_informations WHERE course_id = '$teacher_id';");
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <?php
                                        while($son = $lectureInformations->fetch_assoc()){
                                            ?>
                                            <tbody>
                                            <tr class="tr-shadow">
                                                <td><?php echo $son['lecture_id']?></td>
                                                <td>
                                                    <span class="block-email"><?php echo $son['lecture_name']?></span>
                                                </td>
                                                <td class="desc"><?php echo $son['lecture_description']?></td>
                                                <td> <?php echo $son['lecture_video']?></td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button>
                                                        <a href="delete-lecture.php?lecture_id=<?php echo $son['lecture_id']?>">Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="spacer"></tr>

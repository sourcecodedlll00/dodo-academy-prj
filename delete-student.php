...
if(!isset($_SESSION['oturum'])){
    ...
    if(isset($_GET['enrollment_id'])){
        ...
        $deleteLecture= $db -> query("DELETE FROM enrolled_courses WHERE enrollment_id = '$enrollmentID'");
            ...
            <div class="container-fluid">
                <div class="header-mobile-inner">
                    <a class="logo" href="enrolled-courses.php">
                        <img src="images/icon/vagon-studio-logo-png.png" alt="Vagon Studio Logo" style="height:60px; width:auto;" />
                    </a>
